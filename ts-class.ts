class Company{
    ...
    public readonly country: string = 'Nigeria';
    constructor(public company:string, public branch:string, public department:string, public totalStaff:number){
        this.company = company;
        this.branch = branch;
        this.department = department;
        this.totalStaff = totalStaff;
    }
    protected describe(this:Company){
...
class Division extends Company {
    constructor(public state:string, public region:string){
